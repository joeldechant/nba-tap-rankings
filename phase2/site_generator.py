...
{decade_nav_html}
    ...
    <div class="season-hint" id="season-hint"><p>Everything you see in ORANGE is CLICKABLE for added functionality!<br class="desktop-break"> Player names are also CLICKABLE for a game log or career view!</p><p>&nbsp;</p></div>
