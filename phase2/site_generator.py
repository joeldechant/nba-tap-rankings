...
{decade_nav_html}
    ...
    <div class="season-hint" id="season-hint"><p>Everything you see in ORANGE is CLICKABLE for added functionality!<br><br> Player names are also CLICKABLE for game log or career view!</p><p>&nbsp;</p></div>
