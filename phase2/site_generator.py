      ...
      if (mode === 'diff' || mode === 'diff-player') {{
        if (mg1TextOpen) {{
          ...
          if (mode === 'diff-player') {{
            ...
            textRow.innerHTML = '<td colspan="5" style="text-align:center;padding:12px 16px;cursor:pointer;border:none;background:#000"><p style="font-family:Georgia,serif;font-size:0.85em;font-style:italic;color:#ee7623;margin:0;max-width:25em;display:inline-block">Click <span style="font-weight:700;font-style:normal;color:#ee7623">PLAYER</span> above to sort the top 20 DIFF seasons and see your modern GOAT candidates!</p></td>';
          }}
          if (mode === 'diff') {{
      ...
      if (mode === 'diff' || mode === 'diff-player') {{
        if (mg2TextOpen) {{
          ...
          if (mode === 'diff-player') {{
            ...
            textRow.innerHTML = '<td colspan="5" style="text-align:center;padding:12px 16px;cursor:pointer;border:none;background:#000"><p style="font-family:Georgia,serif;font-size:0.85em;font-style:italic;color:#ee7623;margin:0;max-width:25em;display:inline-block">Click <span style="font-weight:700;font-style:normal;color:#ee7623">PLAYER</span> above to sort the top 30 DIFF seasons and see your modern GOAT candidates!</p></td>';
          }}
          if (mode === 'diff') {{
            tbody.insertBefore(textRow, tbody.children[30]);
          }} else {{
      ...
      if (mode === 'diff' || mode === 'diff-player') {{
        if (mg3TextOpen) {{
          ...
          if (mode === 'diff-player') {{
            ...
            textRow.innerHTML = '<td colspan="5" style="text-align:center;padding:12px 16px;cursor:pointer;border:none;background:#000"><p style="font-family:Georgia,serif;font-size:0.85em;font-style:italic;color:#ee7623;margin:0;max-width:25em;display:inline-block">Click <span style="font-weight:700;font-style:normal;color:#ee7623">PLAYER</span> above to sort the top 40 DIFF seasons and see your modern GOAT candidates!</p></td>';
          }}
          if (mode === 'diff') {{
            tbody.insertBefore(textRow, tbody.children[40]);
          }} else {{
