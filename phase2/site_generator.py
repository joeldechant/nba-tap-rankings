...
{career_js}
  ...
  (function() {{
    ...
    /* Lock description container height to the taller description so
       toggling TED/TAP never shifts content below */
    (function() {{
      var dc = document.querySelector('.description');
      ...
      dc.style.minHeight = Math.max(dt.offsetHeight, dp.offsetHeight) + 'px';
